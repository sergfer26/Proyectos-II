...
* Semana 4 (Regularización de redes):
  ...
  * Miércoles 13 de octubre: Penalización de parámetros, regularización <pre xml:lang="latex">L^2</pre> (primera parte).
...
* Semana 5 (Redes convolucionales 2D [CNN 2D]):
  ...
  * Miércoles 20 de octubre: Definición de capas convolucionales para imágenes con 1 y <pre xml:lang="latex">C</pre> canales, ejemplos. 
